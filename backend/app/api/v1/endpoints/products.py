...
- PackageFormOptions: Configuration for package forms (封装形式)
- PackageTypeOptions: Configuration for package types (封装产品类型)
- ApplicationScenarios: Configuration for application scenarios (应用场景)
"""
