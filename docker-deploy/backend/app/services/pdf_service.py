"""
PDF报表生成服务 - PDF Report Generation Service

本模块使用ReportLab库生成专业的PDF报表，支持工单报表、人员报表和数据分析报表。
支持中文字体渲染，提供表格、图表等多种报表元素。

主要功能:
- 工单列表报表：展示工单基本信息、状态、负责人等
- 人员报表：展示人员信息、技能、工作量等
- 设备报表：展示设备状态、利用率等
- 统计分析报表：展示KPI指标、趋势图等

核心类:
- PDFReportService: PDF报表生成服务类
    - generate_work_order_list_report(): 生成工单列表PDF
    - generate_personnel_report(): 生成人员报表PDF
    - generate_equipment_report(): 生成设备报表PDF
    - generate_analytics_report(): 生成统计分析报表PDF
