...
class EquipmentNameBrief(BaseModel):
    """设备名简要信息"""
    id: int = Field(..., description="设备名ID")
    name: str = Field(..., description="设备名称")
    is_critical: bool = Field(False, description="是否为关键设备")
    category_id: Optional[int] = Field(None, description="类别ID")
...
class EquipmentBase(BaseModel):
    ...
    category: Optional[EquipmentCategory] = Field(None, description="设备类别（旧枚举，兼容保留）")
    category_id: Optional[int] = Field(None, description="设备类别ID（新）")
    equipment_name_id: Optional[int] = Field(None, description="设备名ID（新）")
...
class EquipmentResponse(EquipmentBase):
    ...
    equipment_name: Optional[EquipmentNameBrief] = Field(None, description="设备名信息（包含关键设备标识）")
