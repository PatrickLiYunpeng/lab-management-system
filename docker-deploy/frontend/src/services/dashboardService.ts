/**
 * 仪表盘服务 - Dashboard Service
 * 
 * 本模块提供仪表盘统计数据的API调用封装。
 * 
 * 功能:
 * - 综合摘要：人员、设备、工单、物料统计
 * - 设备利用率：各设备的使用时长和利用率
 ...
 * 
 * 数据类型:
 * - DashboardSummary: 仪表盘综合摘要
 * - EquipmentUtilization: 设备利用率数据
 * - PersonnelEfficiency: 人员效率数据
 * - TaskCompletionStats: 任务完成统计
 * - SLAPerformance: SLA绩效数据
 * - WorkloadAnalysis: 工作负载分析
 */
import api from './api';
