...
import type { Material, Laboratory, Client, MaterialStatus } from '../../types';
...
export function SamplesPanel({
    ...
    async (page = 1, pageSize = 10, signal?: AbortSignal) => {
      ...
      try {
        const response = await materialService.getMaterials({
          ...
          material_type: 'sample', // Fixed filter for samples only
  ...
  useEffect(() => {
    // This will be called when the parent wants to refresh the list
  }, []);
